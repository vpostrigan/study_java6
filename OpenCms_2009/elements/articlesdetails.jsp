...
<cms:contentload collector="singleFile" param="%(opencms.uri)" editable="true">
	...
	%>
	<div class="one_news">
	<div class="news_date"><cms:contentcheck ifexists="Release">
		...
		<% java.text.DateFormat dateformat = 
			java.text.DateFormat.getDateInstance(java.text.DateFormat.LONG, jsp.getRequestContext().getLocale());%>
		<%= dateformat.format(date) %>
	</cms:contentcheck></div>
	<div class="news_anounce full"></div>
	<div class="news_txt"><cms:contentshow element="Text" /></div>
	</div>
</cms:contentload></div>
<br>
