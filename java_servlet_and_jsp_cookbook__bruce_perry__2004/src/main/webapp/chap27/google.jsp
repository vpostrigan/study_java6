...
<c:choose>
    <c:when test="${empty param.query}">
        ...
        <form method="POST" action='<c:out value="${pageContext.request.contextPath}" />/google.jsp'>
            ...
            <table border="0">
                ...
                <tr>
                    <td valign="top">
                        Restrict to Google sub-site...
                    </td>
                    <td valign="top">
                        <select name="restrict">
                            <option selected>none</option>
                            <option>unclesam</option>
                            <option>linux</option>
                            <option>mac</option>
                            <option>bsd</option>
                        </select>
    ...
    <c:otherwise>
        <jsp:useBean id="gBean" class="chap27.GoogleBean"/>
