...
public class UploadBean {
    ...
    public String getUploadedFiles() throws java.io.IOException {
        ...
        MultipartRequest mpr = new MultipartRequest(req, webTempPath, 5 * 1024 * 1024, new MyFileRenamePolicy());

        Enumeration enum0 = mpr.getFileNames();

        StringBuffer buff = new StringBuffer("");

        for (int i = 1; enum0.hasMoreElements(); i++) {
            buff.append("The name of uploaded file ").append(i).
                    append(" is: ").
                    append(mpr.getFilesystemName((String) enum0.nextElement())).
                    append("<br><br>");
        }//for
