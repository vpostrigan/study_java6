...
public class ToXmlValidator extends TagLibraryValidator {
    ...
    public ValidationMessage[] validate(java.lang.String prefix,
        ...
        try {
            ResourceBundle bundle = ResourceBundle.getBundle("com.jspservletcookbook.validator");
            ...
            if (directory == null)
                throw new Exception("Received a null directory for the XML view file.");
            //throw an Exception if the file name is invalid
            if (fileName == null)
                throw new IOException("Received a null filename for the XML view file.");
            ...
            ValidationMessage vmsg = new ValidationMessage(null, io.getMessage());
            ...
            //return a validation message
            ValidationMessage vmsg = new ValidationMessage(null, e.getMessage());
            vam = new ValidationMessage[1];
            vam[0] = vmsg;
            return vam;
        }
