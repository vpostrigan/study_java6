    ...
    class MyParserCallback extends ParserCallback {
        ...
        public void handleText(char[] data, int pos) {
            ...
            if (htmlText.indexOf("No such ticker symbol.") != -1) {
                throw new IllegalStateException("Invalid ticker symbol in handleText() method.");
                ...
                try {
                    ...
                    try {
                        ...
                        throw new IllegalStateException("The extracted text " + htmlText + " cannot be parsed as a number!");
                    }//try
                }//try
                lastTradeFlag = false;
                boldFlag = false;
