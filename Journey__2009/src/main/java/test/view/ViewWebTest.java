...
public class ViewWebTest extends WebTestCase{
	
	public ViewWebTest(String name){
		super(name);
	}
	
	public void setUp() throws Exception{
		TestContext testContext = getTestContext();
		testContext.setBaseUrl("http://localhost:8080/Journey");
		testContext.setResourceBundleName("home");
	}
	
	public void testAppAvailable(){
		beginAt("/pages/index.jsp");
		
		assertElementPresent("cities");
		assertElementPresent("map_canvas");
	}
	
	public void testLanguage(){
		beginAt("/pages/index.jsp");
		
		this.clickLinkWithImage("/Journey/css/img/ru.jpg");
	}
	...
	public void testUsers() {
		...
		this.clickLinkWithText("Пользователи");		
		this.clickLinkWithText("Манипулирование с пользователями");
	}
	...
	public void testAddAndDeleteUser() {
		...
		this.clickButtonWithText("Добавить");
